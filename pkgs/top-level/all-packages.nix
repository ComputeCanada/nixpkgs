...

{
  ...
  emacs = self.emacs25;
  emacsPackages = self.emacs25Packages;
  emacsPackagesNg = self.emacs25PackagesNg;
  emacsMelpa = self.emacs25PackagesNg; # for backward compatibility
  ...
  emacs25-nox = lowPrio (appendToName "nox" (self.emacs25.override {
    withX = false;
    withGTK2 = false;
    withGTK3 = false;
  }));
